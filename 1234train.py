...
#opposite
messages = ["1234 78 49 48 100 1", "1234 78 47 46 3 1", "1234 78 45 43 6 1", "1234 78 42 41 0 1"]

#same direction 					Run first this 
#messages = ["1234 78 31 32 100 1", "1234 78 33 34 100 1", "1234 78 35 36 100 1", "1234 78 37 38 100 1","1234 78 39 40 100 1", "1234 78 41 42 100 1", "1234 78 43 44 100 1", "1234 78 45 46 100 1"]
connected = True		
FORMAT = 'utf-8'
STOP = 0
